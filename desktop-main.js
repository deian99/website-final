...
function constructHeader () {
    navbar.innerHTML += '<div class="logo">' +
        ...
        '</div>' +
        '<div class="route"><select name="language" id="language"><option value="EN">EN</option></select></div>' +
        '</div>\n' +
...
function constructMain() {
    ...
    main.innerHTML =
        ...
        <section id="section2">
        <div class="poster-container"><div class="poster-inner"><h1 style="font-size: 1.8rem; font-weight: 900;">Stay safe, wear equipment</h1><h3 style="font-size:1rem;">Ride safe, it's totally worth it.</h3></div><div class="icon-container"><img src="helmet-icon.jpg" alt="icon" class="icon"></div>
        </div>
        <div class="section2-header">BEST OF</div>
        <div id="posts-filter"></div>
        <div id="posts"></div>
        </section>
    ...
    let whatsNew = document.getElementById('post-list')
    ...
    for (let i = 0; i < filters.length; i++) {
        filterSection.innerHTML += `<div class="filter">${filters[i]}</div>`
    }
